...
import { Call } from "@/types"; // or define the shape if you don’t have this
...
export function KpiCards({ calls }: KpiCardsProps) {
  const metrics = useKpiMetrics(calls);
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      ...
      <KpiCard
        ...
        value={Number(metrics.avgDuration)}
        suffix="s"
      ...
      <KpiCard
        ...
        value={Number(metrics.avgFeedbackQuality)}
        suffix="%"
